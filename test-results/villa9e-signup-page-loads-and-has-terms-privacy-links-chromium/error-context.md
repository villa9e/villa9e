...
- Name: villa9e.spec.ts >> signup page loads and has terms/privacy links
- Location: tests/villa9e.spec.ts:20:5
...
Call log:
  - navigating to "https://villa9e.app/signup", waiting until "load"
