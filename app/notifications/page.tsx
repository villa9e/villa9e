            ...
            <div key={day}>
              ...
              <div className="space-y-2">
                {notifs.map((n: any) => {
                  ...
                  return (
                    <Link key={n.id} href={cfg.href(n.reference_id ?? '')} onClick={() => !n.is_read && markRead(n.id)}>
                      <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }}
                        ...
                        {!n.is_read && (
                          <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ background: cfg.color }} />
                        )}
                      </motion.div>
                    </Link>
                  );
